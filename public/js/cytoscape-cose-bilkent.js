        ...
        function (require, module, exports) {
          ...
          FDLayout.prototype.calcGravitationalForce = function (node) {
            ...
            if (node.getOwner() == this.graphManager.getRoot()) {
              // in the root graph
              Math.floor(80)
              estimatedSize = Math.floor(ownerGraph.getEstimatedSize() * this.gravityRangeFactor)
              ...
              estimatedSize = Math.floor(ownerGraph.getEstimatedSize() * this.compoundGravityRangeFactor)
